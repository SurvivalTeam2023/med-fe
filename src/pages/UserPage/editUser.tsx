import { Button, Descriptions, Dropdown, Layout, Menu, MenuProps, Table, theme } from "antd";
import { Footer, Header } from "antd/es/layout/layout";
import { getUserDetailAPI } from "api/user";
import { UserData } from "core/interface/models";
import { useAppThunkDispatch } from "core/store";
import { editUserStatusThunk } from "core/store/thunk";
        ...
        <Sider collapsible collapsed={collapsed} onCollapse={(value) => setCollapsed(value)}>
                ...
                <Layout style={{ marginTop: '1%' }}>
                    <Descriptions title="User Info" layout="vertical" bordered>
                        <Descriptions.Item label="First Name">{data?.user_db.username}</Descriptions.Item>
