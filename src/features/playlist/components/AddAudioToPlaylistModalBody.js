...
function AddAudioToPlaylistModalBody({ closeModal, extraObject }) {
  ...
  const saveNewLead = async () => {
    try {
      console.log("leadObj.playlistId", leadObj.playlistId);
      const payload = {
...
export default AddAudioToPlaylistModalBody;
