...
import { useUpdatePlan } from "../../../hooks/plan.hook";

function EditPlanModalBody({ closeModal, extraObject }) {
  ...
  const INITIAL_LEAD_OBJ = {
    ...
    usageTime: extraObject.usageTime,
    cost: extraObject.cost,
  };
...
export default EditPlanModalBody;
