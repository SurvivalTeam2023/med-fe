...
import { TOKEN_KEY_STORAGE, USER_KEY_STORAGE } from "core/constants";
...
export const storeTokenToLocal = async (payload: any) => {
    try {
...
export const storeUserToLocal = async (payload: any) => {
    try {
